        ...
        <div className="grid lg:grid-cols-[55%_45%] gap-12 items-center">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="space-y-6">
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              <button
                onClick={handleCTA}
                className="bg-primary text-primary-foreground font-body font-semibold px-8 py-3.5 rounded-button glow-green hover:brightness-110 transition-all flex items-center gap-2"
              >
                Book Free Call <ArrowRight size={18} />
              </button>
              <button
                onClick={() => scrollToSection("portfolio")}
                className="border border-foreground/10 text-foreground font-body font-medium px-8 py-3.5 rounded-button hover:bg-foreground/5 transition-all flex items-center gap-2"
              >
