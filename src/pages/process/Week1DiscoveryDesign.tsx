        ...
        <div className="min-h-screen bg-[#0a0a0a] text-[#94a3b8] font-body selection:bg-[#00e5a0]/30">
            ...
            <main className="pt-24 pb-20">
                ...
                <section className="container mx-auto px-4 mb-20 text-center">
                    ...
                    >
                        <span className="text-[#00e5a0] font-mono text-sm tracking-[0.2em] font-bold block mb-4 uppercase">
                            WEEK 1
                        </span>
                        ...
                        <p className="text-xl italic text-[#94a3b8] mb-8 font-light max-w-2xl mx-auto">
                    ...
                    <div className="space-y-8 relative">
                        ...
                        {timelineSteps.map((step, idx) => (
                            <motion.div 
                                ...
                                className="group bg-[#111820] rounded-2xl border-l-4 border-[#00e5a0] p-8 shadow-card hover:shadow-card-hover transition-all border border-white/5"
                            >
                                <div className="flex items-start gap-6">
                                    <div className="w-16 h-16 shrink-0 rounded-xl bg-[#00e5a0]/10 flex items-center justify-center group-hover:bg-[#00e5a0]/20 transition-colors">
                                        {step.icon}
                                    </div>
                                    <div>
                ...
                <section className="container mx-auto px-4 max-w-6xl mb-32">
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-[#111820] rounded-2xl border-l-4 border-[#f59e0b] p-8 border border-white/5 h-full">
                            <h3 className="text-2xl font-display font-bold text-white mb-8">What We'll Need From You</h3>
                            ...
                            <p className="mt-8 text-sm italic text-[#94a3b8]/60 p-4 bg-black/20 rounded-xl">
                                Don't have everything? No stress — we guide you through it on our kickoff call.
                            </p>
                        </div>

                        {/* Deliverables Block */}
                        <div className="bg-[#111820] rounded-2xl border border-[#00e5a0]/30 p-8 shadow-[0_0_30px_rgba(0,229,160,0.05)] relative overflow-hidden group">
                           <div className="absolute top-0 right-0 w-32 h-32 bg-[#00e5a0]/5 blur-3xl -mr-16 -mt-16 group-hover:bg-[#00e5a0]/10 transition-all rounded-full" />
                            <h3 className="text-2xl font-display font-bold text-[#00e5a0] mb-8 flex items-center gap-3">
                ...
                {/* 6. FAQ Section */}
                <section className="container mx-auto px-4 max-w-4xl mb-32">
                    <h2 className="text-3xl font-display font-bold text-white mb-12 text-center">Week 1 — Frequently Asked Questions</h2>
                ...
                {/* 7. CTA Section */}
                <section className="container mx-auto px-4 max-w-4xl mb-32">
                    <div className="relative rounded-3xl p-12 overflow-hidden border border-white/10 group">
