...
export default function Signup() {
    const { currentUser, signUpWithEmail, signInWithGoogle, loading } = useAuth();
    ...
    const onSubmit = async (data: SignupFormData) => {
        try {
            ...
            toast.success("Account created! Welcome to Scalvicon 🎉");
            navigate("/dashboard");
        } catch {
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <AuthLeftPanel
                ...
                subtext="Get a stunning website that grows your business — in just 4 weeks."
            />
                ...
                >
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-white/40 text-sm">
                            ...
                            <Link to="/login" className="font-medium" style={{ color: "hsl(162 100% 45%)" }}>
                                Sign in
                            </Link>
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <button
                            ...
                            className={cn(
                                "w-full flex items-center justify-center gap-2 py-3.5 rounded-lg mt-2",
